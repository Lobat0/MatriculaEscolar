...
namespace Matricula.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_usuario,id_pessoa,nome,senha,permissoes")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_usuario,id_pessoa,nome,senha,permissoes")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
