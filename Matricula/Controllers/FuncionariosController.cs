...
namespace Matricula.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_funcionario,id_pessoa,situacao,setor")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_funcionario,id_pessoa,situacao,setor")] Funcionario funcionario)
        {
            if (ModelState.IsValid)
            {
